...
$rst_galeria=mysql_query("SELECT * FROM ".$tabla_suf."_noticia_categoria_slide WHERE noticia=$idnoticia ORDER BY orden ASC;", $conexion);
...
//NOTICIA
$rst_noticia=mysql_query("SELECT * FROM ".$tabla_suf."_noticia_categoria WHERE id=$idnoticia LIMIT 1;", $conexion);
...
<div id="contenedor" class="limpiar">
    ...
    <div id="cuerpo" class="limpiar">
    	<div class="interior">
            ...
            <div id="panel-der">
            	  <h2>Lista - Fotos de categoria: <?php echo $fila_noticia["categoria"] ?></h2>
