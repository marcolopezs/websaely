...
mysql_query("UPDATE ".$tabla_suf."_noticia_categoria_slide SET titulo='$titulo', fecha='$fecha', hora='$hora', usuario='$usuario_user', imagen='$imagen', carpeta='$carpeta' WHERE id=". $_REQUEST["id"].";", $conexion);
