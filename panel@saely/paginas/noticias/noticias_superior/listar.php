...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_noticia WHERE id>0 AND noticia_superior=1 ORDER BY fecha_publicacion DESC;", $conexion);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_noticia WHERE id>0 AND noticia_superior=1 ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_noticia WHERE titulo LIKE '%$buscar%' AND noticia_superior=1 ORDER BY fecha_publicacion DESC;", $conexion);
	$num_registros=mysql_num_rows($rst_query);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_noticia WHERE titulo LIKE '%$buscar%' AND noticia_superior=1 ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
	$paginas=ceil($num_registros/$registros);
