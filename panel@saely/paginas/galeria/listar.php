...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_galeria WHERE id>0 ORDER BY id DESC;", $conexion);
...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_galeria WHERE id>0 ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
                  ...
                  <table width="100%" align="center" cellpadding="5" cellspacing="0" id="cebreado-php">
                    <thead>
                      <tr class="titulo-campo">
                        <th width="85%" height="22" align="left">GALERIA</th>
                    ...
                    <tbody>
                      ...
                      <tr<?php echo alt($zebra); $zebra++; ?>>
                        <td width="85%">
                            <p><strong class="up"><?php echo $fila["titulo"]; ?></strong></p></td>
                        <td width="15%" align="center">
                        <a onclick="eliminarRegistro(<?php echo $fila["id"].", '".$fila["titulo"] ?>');" href="javascript:;">
                        ...
                        <a href="slide/listar.php?noticia=<?php echo $fila["id"] ?>">
                        	<img src="../../images/mult_32.png" width="16" height="16" alt="Paginas" title="Ver fotos" />
                        </a>
                        </td>
                      </tr>
                      <?php } ?>
